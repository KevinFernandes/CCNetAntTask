...
namespace ccnet.AntTask.plugin
{
    using System;
    ...
    /// </para>
    /// <para type="tip">
    /// See <link>Using CruiseControl.NET with Ant</link> for more information on working with Ant and CruiseControl.Net.
    /// </para>
    /// <para type="tip">
    ...
    /// </example>
    /// <remarks>
    /// <heading>Ant output in Xml</heading>
    /// <para>
    /// CruiseControl.NET expects Ant to generate its output as Xml so that the build results can be parsed and rendered appropriately. To
    /// accomplish this, CruiseControl.NET will, by default, launch Ant using the "-logger:Ant.Core.XmlLogger" argument. If you want to
    /// override this behaviour, specify the logger property in the AntBuilder configuration in the ccnet.config file. If this element is
    /// specified but is empty then Ant will be started with the default logger (though this may cause some problems for CCNet). It is also
    /// possible to instruct Ant to log its output to an Xml file and then merge the file into the build using the File Merge Task.
    /// </para>
    /// <para type="warning">
    /// The configuration of which Ant logger to use was orginally specified in the ccnet.exe.config file. This has now been deprecated,
    /// and the "Ant.Logger" element in the &lt;appSettings&gt; section can now be removed.
    /// </para>
    /// <heading>NUnit and Ant</heading>
    /// <para>
    ...
    /// nunit2 task in Ant can produce xml output. The tasks must be configured to do that in order for test results to show up on the web
    ...
    /// &lt;/nant&gt;
    /// </code>
    /// <heading>Accessing CruiseControl.NET build labels in Ant</heading>
    /// <para>
    /// CCNet will pass the current build label to Ant via the Ant property CCNetLabel. This means that you can access use this property to,
    ...
    /// Here's an example Ant script demonstrating how to do this:
    /// </para>
    /// <code>
		...
		: BaseExecutableTask
    {
        ...
        /// </summary>
        /// <remarks></remarks>
        public const string logFilename = "ant-results-{0}.xml";
        /// <summary>
        /// 	
        /// </summary>
        /// <remarks></remarks>
        ...
        /// </summary>
        /// <remarks></remarks>
        public const string defaultExecutable = "ant";
        /// <summary>
        /// 	
        /// </summary>
        /// <remarks></remarks>
        ...
        /// </summary>
        /// <remarks></remarks>
        public const string DefaultListener = "";
        /// <summary>
        /// 	
        /// </summary>
        /// <remarks></remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="AntTask" /> class.	
		/// </summary>
		/// <remarks></remarks>
		public AntTask() :
		...
		/// <remarks></remarks>
		public AntTask( ProcessExecutor executor )
		{
        ...
        #region Targets
        /// <summary>
        /// A list of targets to be called. CruiseControl.NET does not call Ant once for each target, it uses the Ant feature of being
        ...
        /// <summary>
        /// The directory to run the Ant process in. If relative, is a subdirectory of the Project Working Directory.
        /// </summary>
        /// <version>1.0</version>
        ...
        #region BuildArgs
        /// <summary>
        /// Any arguments to pass through to Ant (e.g to specify build properties).
        /// </summary>
        /// <version>1.0</version>
        ...
        #region Logger
        /// <summary>
        /// The Ant logger to use.
        /// </summary>
        /// <version>1.0</version>
        /// <default>Ant.Core.XmlLogger</default>
        ...
        #region Listener
        /// <summary>
        /// The Ant listener to use. 
        /// </summary>
        /// <version>1.5</version>
        /// <default>Ant.Core.DefaultLogger</default>
        ...
        /// <summary>
        /// Runs the integration using Ant.  The build number is provided for labelling, build
        /// timeouts are enforced.  The specified targets are used for the specified Ant build file.
        ...
        protected override bool Execute(IIntegrationResult result)
        {
            ...
            result.BuildProgressInformation.SignalStartRunTask(!string.IsNullOrEmpty(Description) ? Description :
                    string.Format(System.Globalization.CultureInfo.CurrentCulture, "Executing Ant :BuildFile: {0} Targets: {1} ", BuildFile, string.Join(", ", Targets)));
